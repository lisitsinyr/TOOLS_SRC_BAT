...
rem beginfunction
    ...
    call :PATTERNS_PY_git_push || exit /b 1
...
rem --------------------------------------------------------------------------------
rem procedure PATTERNS_PY_git_push ()
rem --------------------------------------------------------------------------------
:PATTERNS_PY_git_push
    set FUNCNAME=%0
    if defined DEBUG (
        echo DEBUG: procedure !FUNCNAME! ...
    )
    ...
    echo ---------------------------
    echo 3.git push PATTERNS_PY:
    echo ---------------------------
    set DIR_PATTERNS_PY=D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\02_Python\PROJECTS_PY\PATTERN_PY
    cd /D %DIR_PATTERNS_PY%
    set LOG_FILE_ADD=1
