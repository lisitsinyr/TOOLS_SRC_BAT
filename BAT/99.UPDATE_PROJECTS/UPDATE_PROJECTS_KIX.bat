...
rem beginfunction
    ...
    call :FreeFileSync_BAT || exit /b 1
    call :FreeFileSync_LIB || exit /b 1
    call :PROJECTS_KIX_git_push || exit /b 1
    call :TOOLS_KIX_git_push || exit /b 1
    call :TOOLS_KIX_git_pull || exit /b 1   
...
rem =================================================
rem procedure FreeFileSync_BAT ()
rem =================================================
:FreeFileSync_BAT
rem beginfunction
    set FUNCNAME=%0
...
rem =================================================
rem procedure PROJECTS_KIX_git_push ()
rem =================================================
:PROJECTS_KIX_git_push
rem beginfunction
    set FUNCNAME=%0
    if defined DEBUG (
        echo DEBUG: procedure !FUNCNAME! ...
...
rem =================================================
rem procedure TOOLS_KIX_git_push ()
rem =================================================
:TOOLS_KIX_git_push
rem beginfunction
    set FUNCNAME=%0
...
rem =================================================
rem procedure TOOLS_KIX_git_pull ()
rem =================================================
:TOOLS_KIX_git_pull
rem beginfunction
    set FUNCNAME=%0
