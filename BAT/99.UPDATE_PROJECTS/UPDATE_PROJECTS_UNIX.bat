...
rem beginfunction
    ...
    call :FreeFileSync_PROJECTS_BAT || exit /b 1
    call :PROJECTS_UNIX_git_push || exit /b 1
...
rem --------------------------------------------------------------------------------
rem procedure FreeFileSync_PROJECTS_BAT ()
rem --------------------------------------------------------------------------------
:FreeFileSync_PROJECTS_BAT
rem beginfunction
    set FUNCNAME=%0
    if defined DEBUG (
        echo DEBUG: procedure !FUNCNAME! ...
    ...
    echo --------------------------------
    echo 2.FreeFileSync_PROJECTS_BAT: [*]
    echo --------------------------------
...
rem --------------------------------------------------------------------------------
rem PROJECTS_UNIX_git_push ()
rem --------------------------------------------------------------------------------
:PROJECTS_UNIX_git_push
rem beginfunction
    set FUNCNAME=%0
    if defined DEBUG (
        echo DEBUG: procedure !FUNCNAME! ...
