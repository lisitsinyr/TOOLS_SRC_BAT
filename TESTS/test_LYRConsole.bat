...
:begin
    ...
    call :test_WriteDEBUG WriteDEBUG ...
    call :test_WriteINFO WriteINFO ...
    call :test_WriteWARNING WriteWARNING ...
    call :test_WriteERROR WriteERROR ...
    call :test_WriteCRITICAL WriteCRITICAL ...
    call :test_WriteBEGIN WriteBEGIN ...
    call :test_WriteEND WriteEND ...
    call :test_WritePROCESS WritePROCESS ...
    call :test_WriteDEBUGTEXT WriteDEBUGTEXT ...
    call :test_WriteTEXT WriteTEXT ...
